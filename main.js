...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initOperation)\n/* harmony export */ });\nfunction initOperation() {\n  var operation = document.querySelector('[data-week]');\n  var daysWeek = operation.dataset.week.split(',').map(Number);\n  var hourWeek = operation.dataset.hour.split(',').map(Number);\n  var currentDate = new Date();\n  var currentDay = currentDate.getDay();\n  var currentHour = currentDate.getHours();\n  var dayOpen = daysWeek.indexOf(currentDay) !== -1;\n  var hourOpen = currentHour >= hourWeek[0] && currentHour < hourWeek[1];\n\n  if (dayOpen && hourOpen) {\n    operation.classList.add('open');\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/funcionamento.js?");
